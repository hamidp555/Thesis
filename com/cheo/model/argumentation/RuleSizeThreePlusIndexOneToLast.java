...
public class RuleSizeThreePlusIndexOneToLast implements IRule {
	private List<EDU> edus;
	private int index;

	public RuleSizeThreePlusIndexOneToLast(List<EDU> edus, int index){
		this.edus=edus;
		this.index = index;
	}
	...
	public boolean isMatch() {
		if(edus.size() > 3 && index == edus.size()-2){
	...
	public Argument execute() throws Exception {
		...
		EDU twoBefore = edus.get(index-1);
